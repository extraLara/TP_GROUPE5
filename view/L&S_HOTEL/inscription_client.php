        ...
        <div class="mx-auto col-md-6 col-10 bg-white p-5" style="border-radius:5px; box-shadow:1px 5px 1px">
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <h5 class="text-left">Login</h5><input type="login" class="form-control" placeholder="Merci d'entrer un login de 10 chiffres" pattern="GH-..." inputmode="numeric" minlength="10"
       maxlength="10" size="10" id="form9">
            </div>
