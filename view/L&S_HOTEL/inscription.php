    ...
    <div class="container">
      <div class="row">
        <div class="mx-auto col-md-6 col-10 bg-white p-5" style="border-radius:5px; box-shadow:1px 5px 1px">
          <h1 class="mb-4" style="text-shadow: #082D41 1px 2px 1px ;color:#EEBB4D">Me connecter&nbsp;</h1>
          ...
          <form>
            ...
            <p class="text-left" contenteditable="true" style="font-size:12px">(Login de 8 caractères, au moins une Majuscule, une minuscule, un chiffre et un caractère spécial)</p>
